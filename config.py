...
DNSE_ACCOUNT_REPOSITORY_BACKOFF_SECONDS = float(
    os.getenv("DNSE_ACCOUNT_REPOSITORY_BACKOFF_SECONDS", "60.0")
)
...
SANDBOX_CONFIG = {
    "voting_rules": {
        # CKCS mặc định: D1 chốt xu hướng, H1 xác nhận, M15 canh thời điểm.
